package chessPuzzle.utils;

public class CellUtils {

	// method of convert rank and file to a square on the board
	public static String getCellValue(int rank, int file) {
	...
	public static int[] parseCellValue(String position) {
		int[] rankFileValue = new int[2];

		if (position.length() > 2) {
			throw new IllegalArgumentException(
					"Invalid Position: Position is of form E4, where E is file and 4 is rank");
		}
	...
	public static boolean isValidFileAndRank(int file, int rank) {
